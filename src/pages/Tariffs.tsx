...
const Tariffs = () => {
  ...
  const houses = [
    {
      name: "Новичок 2 (частный дом)",
      speed: "50 Мбит/с",
      price: "850",
      features: ["Оптоволокно до дома", "Увеличенная скорость", "СМС-уведомления о платежах", "Статический IP-адрес", "Техподдержка 24/7", "Монтаж включен"]
    },
    {
      name: "Верный (частный дом)",
      speed: "100 Мбит/с",
      price: "1200", 
      features: ["Оптоволокно до дома", "Высокая скорость круглосуточно", "Статический IP-адрес", "СМС-уведомления", "Техподдержка 24/7", "Бесплатная отсрочка платежа", "Wi-Fi роутер"]
    },
    {
      name: "Шустрый (частный дом)",
      speed: "200 Мбит/с",
      price: "1650",
      features: ["Оптоволокно до дома", "Максимальная скорость 200 Мбит/с", "Статический IP-адрес", "СМС-уведомления", "Техподдержка 24/7", "Бесплатная отсрочка платежа", "IP-телевидение", "Wi-Fi роутер"]
    }
  ];
