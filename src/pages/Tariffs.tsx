...
const Tariffs = () => {
  ...
  const houses = [
    {
      name: "Верный (частные дома)",
      speed: "100 Мбит/с",
      price: "1150",
      features: ["Оптоволокно до дома", "Высокая скорость круглосуточно", "Статический IP-адрес", "СМС-уведомления", "Техподдержка 24/7", "Бесплатная отсрочка платежа", "Монтаж и настройка"]
    },
    {
      name: "Шустрый (частные дома)",
      speed: "200 Мбит/с",
      price: "1650", 
      features: ["Оптоволокно до дома", "Максимальная скорость 200 Мбит/с", "Статический IP-адрес", "СМС-уведомления", "Техподдержка 24/7", "Бесплатная отсрочка платежа", "IP-телевидение", "Монтаж и настройка"]
    }
  ];
